...
export default function FAQs() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "The township is strategically connected to Whitefield, Brookfield, Outer Ring Road, Sarjapur Road, and more, with easy access to Hope Farm Junction Metro, Manipal Hospital, and NEXUS Mall."
        },
    {
